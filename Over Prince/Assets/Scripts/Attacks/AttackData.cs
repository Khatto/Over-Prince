...
public static class AttackData {
    ...
    private static Attack TriangleSlimeSlam = new Attack(
        ...
        AttackTrigger.Single, 
        new Hit[] {
            new(40, 21, 15, 35, 15, 3, 0.0f, new Vector2(1000.0f, 0))
        },
...
public class Hit {
    ...
    public Hit(int totalFrames, int startupFrames, int activeFrames, int cancelleableFrame, int hitStunFrames, int damage, float knockdownPower, Vector2 knockback, bool isInterruptible = true, HitContactSound hitContactSound = HitContactSound.Light) {
