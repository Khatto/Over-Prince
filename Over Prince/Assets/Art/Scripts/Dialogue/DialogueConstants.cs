    ...
    public static class IntroScene {
        ...
        public static class PartFour {
            public static Dialogue[] dialogues = {
                ...
                new Dialogue("Because no matter how far you feel you get,", "Music/Song_Name", 3),
        ...
        public static class PartSix {
            public static Dialogue[] dialogues = {
                ...
                new Dialogue("Because at times it feels like we're programs in some simulation...", "Music/Song_Name", 3),
                new Dialogue("With our whole existence being watched for data collection or something...", "Music/Song_Name", 4),
            };
        }
        ...
        public static class PartEight {
            public static Dialogue[] dialogues = {
                ...
                new Dialogue("I've got on these Elevators...", "Music/Song_Name", 4),
            };
        }
